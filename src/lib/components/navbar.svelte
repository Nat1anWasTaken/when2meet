...
<nav
    ...
    inert={mobileHidden}
    class={[
        "absolute inset-x-0 top-0 z-40 h-16 shrink-0 bg-background transition-transform duration-200 ease-out motion-reduce:transition-none md:static md:translate-y-0",
